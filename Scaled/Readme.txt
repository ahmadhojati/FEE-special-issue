...
This code predicts snow depth using topography and vegetation structure.
The code uses the concept of scale breaks to compute coarse resolution features from fine (1m) resolution data.
